...
import { Bluetooth, type LucideIcon, RadioIcon, WifiIcon } from "lucide-react";
...
const FEATURE_LIST = [
	...
	},
	{
		...
		description:
			"Remplacement de l’électronique d’origine par un système Bluetooth performant, pour une utilisation simple et adaptée aux besoins actuels.",
	},
	{
		icon: Bluetooth,
