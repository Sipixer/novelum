...
export const meta: MetaFunction = () => {
	return [
		{
			title: "Conditions Générales de Vente | Novelum",
		},
		{
			name: "description",
			content:
				"Consultez les conditions générales de vente de Novelum pour toute commande de produits sur notre boutique en ligne.",
		},
	];
};
